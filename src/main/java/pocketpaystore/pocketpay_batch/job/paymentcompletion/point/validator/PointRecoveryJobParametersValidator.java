package pocketpaystore.pocketpay_batch.job.paymentcompletion.point.validator;
...
@Component
public class PointRecoveryJobParametersValidator implements JobParametersValidator {
	...
	public void validate(JobParameters parameters) throws InvalidJobParametersException {
		...
		validatePositive(parameters, "staleMinutes");
	}
