package pocketpaystore.pocketpay_batch.job.paymentcompletion.stock.validator;
...
@Component
public class StockRecoveryJobParametersValidator implements JobParametersValidator {
